...
import com.caesarlib.cserialhelper.DataUtils
import com.caesarlib.cserialhelper.SerialPortUtil
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        port.onCSerialCallBackListener(object : CSerialCallback {
            override fun onReceiveData(data: ByteArray) {
                val readString = DataUtils.ByteArrToHex(data, 0, data.size)
